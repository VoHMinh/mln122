...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }: { effectOptions?: any }) => {
  ...
  useEffect(() => {
    ...
    /* ================================================================
       Internal classes — App, Road, CarLights, LightsSticks
       ================================================================ */
    ...
    class Road {
      ...
      createPlane(side: number, _width: number, isRoad: boolean) {
        ...
        let uniforms: Record<string, any> = { uTravelLength: { value: options.length }, uColor: { value: new THREE.Color(isRoad ? options.colors.roadColor : options.colors.islandColor) }, uTime: this.uTime };
        if (isRoad) {
    ...
    class App {
      ...
      initPasses() {
        ...
        this.bloomPass = new EffectPass(this.camera, new BloomEffect({ luminanceThreshold: 0.2 }));
